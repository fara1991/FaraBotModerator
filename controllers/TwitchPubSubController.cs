...
namespace FaraBotModerator
{
    ...
    public class TwitchPubSubController
    {
        ...
        /// 
        /// </summary>
        public void Connect() => _twitchPubSub?.Connect();
        ...
        /// <param name="e"></param>
        private void PubSub_ServiceConnected(object? sender, EventArgs e) => _twitchPubSub?.SendTopics(Properties.Settings.Default.AccessToken);
        ...
        private void PubSub_ListenResponse(object? sender, OnListenResponseArgs e) => _twitchClientController.TwitchPubSubOnListen(e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void PubSub_Followed(object? sender, OnFollowArgs e) => _twitchClientController.TwitchPubSubOnFollow(e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PubSub_BitsReceived(object? sender, OnBitsReceivedV2Args e) => _twitchClientController.SendBitsPubSubMessage(e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PubSub_StreamUp(object? sender, OnStreamUpArgs e) => Console.WriteLine($"Stream just went up! Play delay: {e.PlayDelay}, server time: {e.ServerTime}");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PubSub_StreamDown(object? sender, OnStreamDownArgs e) => Console.WriteLine($"Stream just went down! Server time: {e.ServerTime}");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PubSub_ChannelPointReward(object? sender, OnChannelPointsRewardRedeemedArgs e) => _twitchClientController.SendChannelPointPubSubMessage(e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PubSub_Prediction(object? sender, OnPredictionArgs e) => _twitchClientController.SendPredictionPubSubMessage(e);
    }
}